...
- [ ] G003 | bant:backend | bagimli:G001 | 5-B: HTTP durum kodu disiplini + /process Pydantic şeması | BLOKE(claude cikis kodu  - kota/ag olabilir)
- [ ] G004 | bant:frontend | bagimli:G002 | 4-C: taslak kalıcılığı + beforeunload + logout daraltma | BLOKE(claude cikis kodu  - kota/ag olabilir)
