...
- [ ] G165 | bant:backend | bagimli:G164 | `yazim_birligi.py` adım 0: combining-dot (U+0307) temizliği "Si̇gorta"→"Sigorta" — case_parties.name 6.422 satır / 4.403 tekil + cases.court 1; NFC + "i̇"→"i"; adım 1'den önce koşar; "Sağlik" ı→i kapsam DIŞI; kuru koşu ilk 15, --apply KOŞULMAZ (10.09 kullanıcı kararı)
