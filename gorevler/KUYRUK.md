...
- [ ] G194 | bant:backend | bagimli:- | Teslim cevap yüklemesi: `cevap_yukle` SharePoint yükleme döngüsünden ÖNCE transaction'ı kapatır, sonra teslimi yeniden okuyup yazar — `idle_in_transaction_session_timeout` açılınca commit düşmez (G191 BLOKE kaydındaki kapsam dışı bulgu; kullanıcı kararı 14.09: G191'den önce)
