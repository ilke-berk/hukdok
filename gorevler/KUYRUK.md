...
- [ ] G139 | bant:frontend | bagimli:G138 | Rapor ekranı: kaynak kartları + Kolonlar yan paneli (gruplar/setler/sıra) + dolu açılış + metin sadeleştirme + responsive | BLOKE(testi degistirmeden gecilemedi - gorev tanimi gozden gecirilmeli)
