...
- [ ] G180 | bant:backend | bagimli:G179 | Ek-3 › 03: 11.09 birleştirmesinde farklı tür/esas tek karta toplanan 30 kartı geri ayır (kullanıcı kararı 13.09: ekibin modeli — arabuluculuk↔dava, soruşturma↔ceza ayrı kart) + iki kart arasında `case_relations` AYRISTIRILAN/ILGILI bağı; sönen kart `deleted_at` + föy `onceki_tracking_no` ile geri getirilir, taraflar föyün `ham_veri`sinden; Ek-3 › 02'deki 21 SORU satırı için dava kartı aç
