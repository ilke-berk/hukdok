...
- [x] G179 | bant:backend | bagimli:G178 | `scripts/ekip_cevabi_1209.py`: Ek-3 › 01 çift kart birleştirme (36 + H-15496 föy taşıma) + §3/Ek-2 › 03 sabit çiftler + Ek-3 › 02 8 föy taşıma + Ek-2 › 06/§3 18 kart düzeltmesi + 4 hatalı kopya (belgeler gerçek karta) ve 4 deneme kartı kapatma — 13.09 gündüz kuru koşu temiz, `--apply` KULLANICI koşar (sınıflandırıcı engeli; yedek `pre_g179_20260913.dump` alındı), prod'a DEĞİL; 1 ret (14321/14322 esas farklı) + 28 "Rücu" kartı ekibe soru
