...
export const FileUpload = ({ onFileSelect, selectedFile, onClearFile, isAnalyzing, isComplete = false }: FileUploadProps) => {
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <CardTitle className="flex items-center gap-2 text-foreground">
            ...
            Adı Değiştirilecek Dosyayı Yükleyiniz
          </CardTitle>
      ...
      <CardContent>
        {!selectedFile ? (
          ...
          >
            ...
            <p className="text-lg font-medium text-foreground mb-2">Dosya Yükle</p>
            <p className="text-sm text-muted-foreground">
              PDF, DOCX, DOC, TXT, UDF (UYAP)
            </p>
          </div>
        ) : (
