                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex gap-2">
                        <Button
                            ...
                            onClick={() => navigate("/new-case", { state: { case: caseData } })}
                        >
                            ...
                            <CardContent>
                                {caseData.documents?.length > 0 ? (
                                    <div className="space-y-3">
                                        {caseData.documents.map((doc: { id: number; created_at: string; uploaded_at?: string; document_type_code: string; belge_turu_adi?: string; summary?: string; stored_filename: string; original_filename: string }) => (
                                            <div key={doc.id} className="group flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 rounded-xl border bg-background/50 hover:border-primary/40 transition-all gap-4">
                                                ...
                                                <div className="shrink-0 max-sm:w-full">
                                                    <Button
                                                        ...
                                                        onClick={() => toast.info("Belge Görüntüleme", {
                                                            description: `${doc.original_filename} adlı dosya güvenli SharePoint arşivinde kilitlidir.`
                                                        })}
                                                    >
                                                        Detay / İndir
                                                    </Button>
