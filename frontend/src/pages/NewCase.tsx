...
import {
    ...
    splitPartyNames,
    toUpperTR,
    type EditModeCaseData,
    type EditModeParty,
} from "@/lib/newCasePayload";
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
// Düzenleme modu tipleri + saf yük yardımcıları (editModeFormValues,
// buildCasePayload, toUpperTR, splitPartyNames) `lib/newCasePayload.ts`'te:
// sayfa dosyası yalnız bileşen export eder (react-refresh/only-export-components).
