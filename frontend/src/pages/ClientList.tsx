                    ...
                    <div className="w-full max-w-3xl relative group">
                        ...
                        <div className="relative">
                            ...
                            <Input 
                                ...
                                placeholder="Müvekkil adı, TC, e-posta veya şehir ile hızlıca arayın..."
                                value={searchQuery}
                ...
                <div className="flex flex-col xl:flex-row gap-6 items-start flex-1 min-h-0">
                    ...
                    <div className="w-full xl:w-[280px] shrink-0 flex flex-col gap-4">
                        ...
                        >
                            ...
                            <span className="text-[15px] tracking-wide">Yeni Kişi Ekle</span>
                        </Button>
                    </div>
                            ...
                            <>
                                ...
                                <div className="flex-1 overflow-y-auto p-6 sm:p-8 flex flex-col gap-8">
                                    ...
                                    <div className="flex gap-4 w-full">
                                        <Button
                                            className="flex-1 bg-[#8B1430] hover:bg-[#701026] text-white rounded-md h-11 text-sm font-semibold shadow-sm transition-all active:scale-[0.98]"
